...
void SpreadsheetView::initActions(){
	...
	action_mask_selection = new KAction(KIcon("edit-node"), i18n("&Mask","mask selection"), this);
	action_unmask_selection = new KAction(KIcon("format-remove-node"), i18n("&Unmask","unmask selection"), this);

	action_set_formula = new KAction(KIcon(""), i18n("Assign &Formula"), this);
	action_clear_selection = new KAction(KIcon("edit-clear"), i18n("Clea&r","clear selection"), this);
