...
void SpreadsheetView::initActions(){
    ...
    action_paste_into_selection = new QAction(QIcon("edit-paste"), i18n("Past&e"), this);
    action_mask_selection = new QAction(QIcon("edit-node"), i18n("&Mask Selection"), this);
    action_unmask_selection = new QAction(QIcon("format-remove-node"), i18n("&Unmask Selection"), this);

    action_set_formula = new QAction(QIcon(""), i18n("Assign &Formula"), this);
    action_clear_selection = new QAction(QIcon("edit-clear"), i18n("Clea&r Selection"), this);
    ...
    action_toggle_comments = new QAction(QIcon("document-properties"), i18n("Show Comments"), this);
    action_select_all = new QAction(QIcon("edit-select-all"), i18n("Select All"), this);
    action_add_column = new QAction(QIcon("edit-table-insert-column-left"), i18n("&Add Column"), this);
    action_clear_spreadsheet = new QAction(QIcon("edit-clear"), i18n("Clear Spreadsheet"), this);
    action_clear_masks = new QAction(QIcon("format-remove-node"), i18n("Clear Masks"), this);
    action_sort_spreadsheet = new QAction(QIcon("view-sort-ascending"), i18n("&Sort Spreadsheet"), this);
    action_go_to_cell = new QAction(QIcon("go-jump"), i18n("&Go to Cell"), this);

    // column related actions
    action_insert_columns = new QAction(QIcon("edit-table-insert-column-left"), i18n("&Insert Empty Columns"), this);
    action_remove_columns = new QAction(QIcon("edit-table-delete-column"), i18n("Remo&ve Columns"), this);
    action_clear_columns = new QAction(QIcon("edit-clear"), i18n("Clea&r Columns"), this);
    action_add_columns = new QAction(QIcon("edit-table-insert-column-right"), i18n("&Add Columns"), this);
...
// 	action_set_as_none = new QAction(QIcon(""), i18n("None, Plot Designation"), this);
    ...
    action_sort_asc_column = new QAction(QIcon("view-sort-ascending"), i18n("&Ascending"), this);
    action_sort_desc_column = new QAction(QIcon("view-sort-descending"), i18n("&Descending"), this);
    action_statistics_columns = new QAction(QIcon("view-statistics"), i18n("Column Statisti&cs"), this);

    // row related actions
    action_insert_rows = new QAction(QIcon("edit-table-insert-row-above") ,i18n("&Insert Empty Rows"), this);
    action_remove_rows = new QAction(QIcon("edit-table-delete-row"), i18n("Remo&ve Rows"), this);
    action_clear_rows = new QAction(QIcon("edit-clear"), i18n("Clea&r Rows"), this);
    action_add_rows = new QAction(QIcon("edit-table-insert-row-above"), i18n("&Add Rows"), this);
    action_statistics_rows = new QAction(QIcon("view-statistics"), i18n("Row Statisti&cs"), this);
}
