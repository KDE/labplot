...
WorkbookView::WorkbookView(Workbook* workbook) : QWidget(),
	...
	//Actions
	action_add_spreadsheet = new QAction(QIcon::fromTheme("insert-table"), i18n("Add new Spreadsheet"), this);
	action_add_matrix = new QAction(QIcon::fromTheme("insert-table"), i18n("Add new Matrix"), this);
