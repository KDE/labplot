...
struct funs _special_functions[] = {
	...
	{[]() { return i18n("Cell"); }, specialfun_cell, nsl_sf_dummy2, 2, nullptr, FunctionGroups::MovingStatistics},
	{[]() { return i18n("Moving Average"); }, specialfun_ma, nsl_sf_dummy, 1, nullptr, FunctionGroups::MovingStatistics},
	{[]() { return i18n("Moving Range"); }, specialfun_mr, nsl_sf_dummy, 1, nullptr, FunctionGroups::MovingStatistics},
	{[]() { return i18n("Simple Moving Minimum"); }, specialfun_smmin, nsl_sf_dummy, 2, nullptr, FunctionGroups::MovingStatistics},
	{[]() { return i18n("Simple Moving Maximum"); }, specialfun_smmax, nsl_sf_dummy, 2, nullptr, FunctionGroups::MovingStatistics},
	{[]() { return i18n("Simple Moving Average"); }, specialfun_sma, nsl_sf_dummy, 2, nullptr, FunctionGroups::MovingStatistics},
	{[]() { return i18n("Simple Moving Range"); }, specialfun_smr, nsl_sf_dummy, 2, nullptr, FunctionGroups::MovingStatistics},
	...
	{[]() { return i18n("Size"); }, colfun_size, nsl_sf_dummy, 1, nullptr, FunctionGroups::ColumnStatistics},
	{[]() { return i18n("Minimum"); }, colfun_min, nsl_sf_dummy, 1, nullptr, FunctionGroups::ColumnStatistics},
	{[]() { return i18n("Maximum"); }, colfun_max, nsl_sf_dummy, 1, nullptr, FunctionGroups::ColumnStatistics},
	{[]() { return i18n("Arithmetic mean"); }, colfun_mean, nsl_sf_dummy, 1, nullptr, FunctionGroups::ColumnStatistics},
	{[]() { return i18n("Median"); }, colfun_median, nsl_sf_dummy, 1, nullptr, FunctionGroups::ColumnStatistics},
	{[]() { return i18n("Standard deviation"); }, colfun_stdev, nsl_sf_dummy, 1, nullptr, FunctionGroups::ColumnStatistics},
	{[]() { return i18n("Variance"); }, colfun_var, nsl_sf_dummy, 1, nullptr, FunctionGroups::ColumnStatistics},
	{[]() { return i18n("Geometric mean"); }, colfun_gm, nsl_sf_dummy, 1, nullptr, FunctionGroups::ColumnStatistics},
	{[]() { return i18n("Harmonic mean"); }, colfun_hm, nsl_sf_dummy, 1, nullptr, FunctionGroups::ColumnStatistics},
	{[]() { return i18n("Contraharmonic mean"); }, colfun_chm, nsl_sf_dummy, 1, nullptr, FunctionGroups::ColumnStatistics},
	{[]() { return i18n("Mode"); }, colfun_mode, nsl_sf_dummy, 1, nullptr, FunctionGroups::ColumnStatistics},
	{[]() { return i18n("First quartile"); }, colfun_quartile1, nsl_sf_dummy, 1, nullptr, FunctionGroups::ColumnStatistics},
	{[]() { return i18n("Third quartile"); }, colfun_quartile3, nsl_sf_dummy, 1, nullptr, FunctionGroups::ColumnStatistics},
	{[]() { return i18n("Interquartile range"); }, colfun_iqr, nsl_sf_dummy, 1, nullptr, FunctionGroups::ColumnStatistics},
	{[]() { return i18n("1st percentile"); }, colfun_percentile1, nsl_sf_dummy, 1, nullptr, FunctionGroups::ColumnStatistics},
	{[]() { return i18n("5th percentile"); }, colfun_percentile5, nsl_sf_dummy, 1, nullptr, FunctionGroups::ColumnStatistics},
	{[]() { return i18n("10th percentile"); }, colfun_percentile10, nsl_sf_dummy, 1, nullptr, FunctionGroups::ColumnStatistics},
	{[]() { return i18n("90th percentile"); }, colfun_percentile90, nsl_sf_dummy, 1, nullptr, FunctionGroups::ColumnStatistics},
	{[]() { return i18n("95th percentile"); }, colfun_percentile95, nsl_sf_dummy, 1, nullptr, FunctionGroups::ColumnStatistics},
	{[]() { return i18n("99th percentile"); }, colfun_percentile99, nsl_sf_dummy, 1, nullptr, FunctionGroups::ColumnStatistics},
	{[]() { return i18n("Trimean"); }, colfun_trimean, nsl_sf_dummy, 1, nullptr, FunctionGroups::ColumnStatistics},
	{[]() { return i18n("Mean absolute deviation"); }, colfun_meandev, nsl_sf_dummy, 1, nullptr, FunctionGroups::ColumnStatistics},
	{[]() { return i18n("Mean absolute deviation around median"); }, colfun_meandevmedian, nsl_sf_dummy, 1, nullptr, FunctionGroups::ColumnStatistics},
	{[]() { return i18n("Median absolute deviation"); }, colfun_mediandev, nsl_sf_dummy, 1, nullptr, FunctionGroups::ColumnStatistics},
	{[]() { return i18n("Skewness"); }, colfun_skew, nsl_sf_dummy, 1, nullptr, FunctionGroups::ColumnStatistics},
	{[]() { return i18n("Kurtosis"); }, colfun_kurt, nsl_sf_dummy, 1, nullptr, FunctionGroups::ColumnStatistics},
	{[]() { return i18n("Entropy"); }, colfun_entropy, nsl_sf_dummy, 1, nullptr, FunctionGroups::ColumnStatistics},
	{[]() { return i18n("Quantile"); }, colfun_quantile, nsl_sf_dummy2, 2, nullptr, FunctionGroups::ColumnStatistics},
	{[]() { return i18n("Percentile"); }, colfun_percentile, nsl_sf_dummy2, 2, nullptr, FunctionGroups::ColumnStatistics},
};
