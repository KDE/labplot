...
struct funs _functions[] = {
	...
	{i18n("Smallest integral value not less"), "ceil", (func_t) static_cast<double (*)(double)>(&ceil), 1, FunctionGroups::StandardMathematicalFunctions},
	{i18n("Absolute value"), "fabs", (func_t) static_cast<double (*)(double)>(&fabs), 1, FunctionGroups::StandardMathematicalFunctions},

	{i18n("Base 10 logarithm"), "log10", (func_t) static_cast<double (*)(double)>(&log10), 1, FunctionGroups::StandardMathematicalFunctions},
	{i18n("Power function [x^y]"), "pow", (func_t) static_cast<double (*)(double, double)>(&pow), 2, FunctionGroups::StandardMathematicalFunctions},
	{i18n("Nonnegative square root"), "sqrt", (func_t) static_cast<double (*)(double)>(&sqrt), 1, FunctionGroups::StandardMathematicalFunctions},
	{i18n("Sign function"), "sgn", (func_t)nsl_sf_sgn, 1, FunctionGroups::StandardMathematicalFunctions},
	{i18n("Heavyside theta function"), "theta", (func_t)nsl_sf_theta, 1, FunctionGroups::StandardMathematicalFunctions},
	{i18n("Harmonic number function"), "harmonic", (func_t)nsl_sf_harmonic, 1, FunctionGroups::StandardMathematicalFunctions},

#ifndef HAVE_WINDOWS
	{i18n("Cube root"), "cbrt", (func_t) static_cast<double (*)(double)>(&cbrt), 1, FunctionGroups::StandardMathematicalFunctions},
	...
	{QStringLiteral("x^n"), "powint", (func_t)nsl_sf_powint, 2, FunctionGroups::StandardMathematicalFunctions},
	{QStringLiteral("x^2"), "pow2", (func_t)gsl_pow_2, 1, FunctionGroups::StandardMathematicalFunctions},
	{QStringLiteral("x^3"), "pow3", (func_t)gsl_pow_3, 1, FunctionGroups::StandardMathematicalFunctions},
	{QStringLiteral("x^4"), "pow4", (func_t)gsl_pow_4, 1, FunctionGroups::StandardMathematicalFunctions},
	{QStringLiteral("x^5"), "pow5", (func_t)gsl_pow_5, 1, FunctionGroups::StandardMathematicalFunctions},
	{QStringLiteral("x^6"), "pow6", (func_t)gsl_pow_6, 1, FunctionGroups::StandardMathematicalFunctions},
	{QStringLiteral("x^7"), "pow7", (func_t)gsl_pow_7, 1, FunctionGroups::StandardMathematicalFunctions},
	...
	{i18n("Arithmetic mean"), "mean", (func_t)nsl_sf_dummy, 1, FunctionGroups::ColumnStatistics},
	{i18n("Median"), "median", (func_t)nsl_sf_dummy, 1, FunctionGroups::ColumnStatistics},
	{i18n("Standard deviation"), "stdev", (func_t)nsl_sf_dummy, 1, FunctionGroups::ColumnStatistics},
	{i18n("Variance"), "var", (func_t)nsl_sf_dummy, 1, FunctionGroups::ColumnStatistics},
	{i18n("Geometric mean"), "gm", (func_t)nsl_sf_dummy, 1, FunctionGroups::ColumnStatistics},
	{i18n("Harmonic mean"), "hm", (func_t)nsl_sf_dummy, 1, FunctionGroups::ColumnStatistics},
	{i18n("Contraharmonic mean"), "chm", (func_t)nsl_sf_dummy, 1, FunctionGroups::ColumnStatistics},
	{i18n("Mode"), "mode", (func_t)nsl_sf_dummy, 1, FunctionGroups::ColumnStatistics},
	{i18n("First quartile"), "quartile1", (func_t)nsl_sf_dummy, 1, FunctionGroups::ColumnStatistics},
	{i18n("Third quartile"), "quartile3", (func_t)nsl_sf_dummy, 1, FunctionGroups::ColumnStatistics},
	{i18n("Interquartile range"), "iqr", (func_t)nsl_sf_dummy, 1, FunctionGroups::ColumnStatistics},
	{i18n("1st percentile"), "percentile1", (func_t)nsl_sf_dummy, 1, FunctionGroups::ColumnStatistics},
	{i18n("5th percentile"), "percentile5", (func_t)nsl_sf_dummy, 1, FunctionGroups::ColumnStatistics},
	{i18n("10th percentile"), "percentile10", (func_t)nsl_sf_dummy, 1, FunctionGroups::ColumnStatistics},
	{i18n("90th percentile"), "percentile90", (func_t)nsl_sf_dummy, 1, FunctionGroups::ColumnStatistics},
	{i18n("95th percentile"), "percentile95", (func_t)nsl_sf_dummy, 1, FunctionGroups::ColumnStatistics},
	{i18n("99th percentile"), "percentile99", (func_t)nsl_sf_dummy, 1, FunctionGroups::ColumnStatistics},
	{i18n("Trimean"), "trimean", (func_t)nsl_sf_dummy, 1, FunctionGroups::ColumnStatistics},
	{i18n("Mean absolute deviation"), "meandev", (func_t)nsl_sf_dummy, 1, FunctionGroups::ColumnStatistics},
	{i18n("Mean absolute deviation around median"), "meandevmedian", (func_t)nsl_sf_dummy, 1, FunctionGroups::ColumnStatistics},
	{i18n("Median absolute deviation"), "mediandev", (func_t)nsl_sf_dummy, 1, FunctionGroups::ColumnStatistics},
	{i18n("Skewness"), "skew", (func_t)nsl_sf_dummy, 1, FunctionGroups::ColumnStatistics},
	{i18n("Kurtosis"), "kurt", (func_t)nsl_sf_dummy, 1, FunctionGroups::ColumnStatistics},
	{i18n("Entropy"), "entropy", (func_t)nsl_sf_dummy, 1, FunctionGroups::ColumnStatistics},
	...
	{i18n("Simple Moving Minimum"), "smmin", (func_t)nsl_sf_dummy, 2, FunctionGroups::MovingStatistics},
	{i18n("Simple Moving Maximum"), "smmax", (func_t)nsl_sf_dummy, 2, FunctionGroups::MovingStatistics},
	{i18n("Simple Moving Average"), "sma", (func_t)nsl_sf_dummy, 2, FunctionGroups::MovingStatistics},
	...
	{i18n("Scaled Airy function of the second kind"), "Bis", (func_t)nsl_sf_airy_Bis, 1, FunctionGroups::AiryFunctionsAndDerivatives},
	{i18n("Airy function derivative of the first kind"), "Aid", (func_t)nsl_sf_airy_Aid, 1, FunctionGroups::AiryFunctionsAndDerivatives},
	{i18n("Airy function derivative of the second kind"), "Bid", (func_t)nsl_sf_airy_Bid, 1, FunctionGroups::AiryFunctionsAndDerivatives},
	{i18n("Scaled Airy function derivative of the first kind"), "Aids", (func_t)nsl_sf_airy_Aids, 1, FunctionGroups::AiryFunctionsAndDerivatives},
	{i18n("Scaled Airy function derivative of the second kind"), "Bids", (func_t)nsl_sf_airy_Bids, 1, FunctionGroups::AiryFunctionsAndDerivatives},
	{i18n("n-th zero of the Airy function of the first kind"), "Ai0", (func_t)nsl_sf_airy_0_Ai, 1, FunctionGroups::AiryFunctionsAndDerivatives},
	{i18n("n-th zero of the Airy function of the second kind"), "Bi0", (func_t)nsl_sf_airy_0_Bi, 1, FunctionGroups::AiryFunctionsAndDerivatives},
	...
	{i18n("Irregular cylindrical Bessel function of zeroth order"), "Y0", (func_t)gsl_sf_bessel_Y0, 1, FunctionGroups::BesselFunctions},
	{i18n("Irregular cylindrical Bessel function of first order"), "Y1", (func_t)gsl_sf_bessel_Y1, 1, FunctionGroups::BesselFunctions},
	{i18n("Irregular cylindrical Bessel function of order n"), "Yn", (func_t)nsl_sf_bessel_Yn, 2, FunctionGroups::BesselFunctions},
	{i18n("Regular modified cylindrical Bessel function of zeroth order"), "I0", (func_t)gsl_sf_bessel_I0, 1, FunctionGroups::BesselFunctions},
	{i18n("Regular modified cylindrical Bessel function of first order"), "I1", (func_t)gsl_sf_bessel_I1, 1, FunctionGroups::BesselFunctions},
	{i18n("Regular modified cylindrical Bessel function of order n"), "In", (func_t)nsl_sf_bessel_In, 2, FunctionGroups::BesselFunctions},
	...
	{i18n("Scaled regular modified cylindrical Bessel function of order n exp(-|x|) In(x)"),
	 ...
	 2,
	 FunctionGroups::BesselFunctions},
	{i18n("Irregular modified cylindrical Bessel function of zeroth order"), "K0", (func_t)gsl_sf_bessel_K0, 1, FunctionGroups::BesselFunctions},
	{i18n("Irregular modified cylindrical Bessel function of first order"), "K1", (func_t)gsl_sf_bessel_K1, 1, FunctionGroups::BesselFunctions},
	{i18n("Irregular modified cylindrical Bessel function of order n"), "Kn", (func_t)nsl_sf_bessel_Kn, 2, FunctionGroups::BesselFunctions},
	...
	{i18n("Scaled irregular modified cylindrical Bessel function of order n exp(x) Kn(x)"),
	 ...
	 2,
	 FunctionGroups::BesselFunctions},
	{i18n("Regular spherical Bessel function of zeroth order"), "j0", (func_t)gsl_sf_bessel_j0, 1, FunctionGroups::BesselFunctions},
	{i18n("Regular spherical Bessel function of first order"), "j1", (func_t)gsl_sf_bessel_j1, 1, FunctionGroups::BesselFunctions},

	{i18n("Regular spherical Bessel function of second order"), "j2", (func_t)gsl_sf_bessel_j2, 1, FunctionGroups::BesselFunctions},
	{i18n("Regular spherical Bessel function of order l"), "jl", (func_t)nsl_sf_bessel_jl, 2, FunctionGroups::BesselFunctions},
	{i18n("Irregular spherical Bessel function of zeroth order"), "y0", (func_t)gsl_sf_bessel_y0, 1, FunctionGroups::BesselFunctions},
	{i18n("Irregular spherical Bessel function of first order"), "y1", (func_t)gsl_sf_bessel_y1, 1, FunctionGroups::BesselFunctions},
	{i18n("Irregular spherical Bessel function of second order"), "y2", (func_t)gsl_sf_bessel_y2, 1, FunctionGroups::BesselFunctions},
	{i18n("Irregular spherical Bessel function of order l"), "yl", (func_t)nsl_sf_bessel_yl, 2, FunctionGroups::BesselFunctions},
	...
	{i18n("Scaled irregular modified spherical Bessel function of order l, exp(-|x|) kl(x)"),
	 ...
	 2,
	 FunctionGroups::BesselFunctions},
	{i18n("Regular cylindrical Bessel function of fractional order"), "Jnu", (func_t)gsl_sf_bessel_Jnu, 2, FunctionGroups::BesselFunctions},
	{i18n("Irregular cylindrical Bessel function of fractional order"), "Ynu", (func_t)gsl_sf_bessel_Ynu, 2, FunctionGroups::BesselFunctions},
	{i18n("Regular modified Bessel function of fractional order"), "Inu", (func_t)gsl_sf_bessel_Inu, 2, FunctionGroups::BesselFunctions},
	{i18n("Scaled regular modified Bessel function of fractional order"), "Inus", (func_t)gsl_sf_bessel_Inu_scaled, 2, FunctionGroups::BesselFunctions},
	{i18n("Irregular modified Bessel function of fractional order"), "Knu", (func_t)gsl_sf_bessel_Knu, 2, FunctionGroups::BesselFunctions},
	{i18n("Logarithm of irregular modified Bessel function of fractional order"), "lnKnu", (func_t)gsl_sf_bessel_lnKnu, 2, FunctionGroups::BesselFunctions},

	{i18n("Scaled irregular modified Bessel function of fractional order"), "Knus", (func_t)gsl_sf_bessel_Knu_scaled, 2, FunctionGroups::BesselFunctions},
	{i18n("n-th positive zero of the Bessel function J0"), "J0_0", (func_t)nsl_sf_bessel_0_J0, 1, FunctionGroups::BesselFunctions},
	...
	{i18n("Fourth-order Debye function"), "D4", (func_t)gsl_sf_debye_4, 1, FunctionGroups::DebyeFunctions},
	...
	{i18n("Legendre form of incomplete elliptic integral F"), "F", (func_t)nsl_sf_ellint_F, 2, FunctionGroups::EllipticIntegrals},
	{i18n("Legendre form of incomplete elliptic integral E"), "E", (func_t)nsl_sf_ellint_E, 2, FunctionGroups::EllipticIntegrals},
	{i18n("Legendre form of incomplete elliptic integral P"), "P", (func_t)nsl_sf_ellint_P, 3, FunctionGroups::EllipticIntegrals},
	{i18n("Legendre form of incomplete elliptic integral D"), "D", (func_t)nsl_sf_ellint_D, 2, FunctionGroups::EllipticIntegrals},
	{i18n("Carlson form of incomplete elliptic integral RC"), "RC", (func_t)nsl_sf_ellint_RC, 2, FunctionGroups::EllipticIntegrals},
	{i18n("Carlson form of incomplete elliptic integral RD"), "RD", (func_t)nsl_sf_ellint_RD, 3, FunctionGroups::EllipticIntegrals},
	...
	{i18n("Gaussian probability density function Z"), "erf_Z", (func_t)gsl_sf_erf_Z, 1, FunctionGroups::ErrorFunctions},
	{i18n("Upper tail of the Gaussian probability function Q"), "erf_Q", (func_t)gsl_sf_erf_Q, 1, FunctionGroups::ErrorFunctions},
	{i18n("Hazard function for the normal distribution Z/Q"), "hazard", (func_t)gsl_sf_hazard, 1, FunctionGroups::ErrorFunctions},
#ifndef _MSC_VER
	{i18n("Underflow-compensating function exp(x^2) erfc(x) for real x"), "erfcx", (func_t)nsl_sf_erfcx, 1, FunctionGroups::ErrorFunctions},
	{i18n("Imaginary error function erfi(x) = -i erf(ix) for real x"), "erfi", (func_t)nsl_sf_erfi, 1, FunctionGroups::ErrorFunctions},
	...
	{i18n("Dawson's integral D(z) = sqrt(pi)/2 * exp(-z^2) * erfi(z)"), "dawson", (func_t)nsl_sf_dawson, 1, FunctionGroups::ErrorFunctions},
	{i18n("Voigt profile"), "voigt", (func_t)nsl_sf_voigt, 3, FunctionGroups::ErrorFunctions},
#endif
	...
	{QStringLiteral("(exp(x)-1)/x"), "exprel", (func_t)gsl_sf_exprel, 1, FunctionGroups::ExponentialFunctions},
	...
	{i18n("Exponential integral Ei"), "Ei", (func_t)gsl_sf_expint_Ei, 1, FunctionGroups::ExponentialIntegrals},
	{i18n("Hyperbolic integral Shi"), "Shi", (func_t)gsl_sf_Shi, 1, FunctionGroups::ExponentialIntegrals},
	{i18n("Hyperbolic integral Chi"), "Chi", (func_t)gsl_sf_Chi, 1, FunctionGroups::ExponentialIntegrals},
	{i18n("Third-order exponential integral"), "Ei3", (func_t)gsl_sf_expint_3, 1, FunctionGroups::ExponentialIntegrals},
	{i18n("Sine integral"), "Si", (func_t)gsl_sf_Si, 1, FunctionGroups::ExponentialIntegrals},
	...
	{i18n("Complete Fermi-Dirac integral with index 2"), "F2", (func_t)gsl_sf_fermi_dirac_2, 1, FunctionGroups::FermiDiracFunction},
	{i18n("Complete Fermi-Dirac integral with integer index j"), "Fj", (func_t)nsl_sf_fermi_dirac_int, 2, FunctionGroups::FermiDiracFunction},
	{i18n("Complete Fermi-Dirac integral with index -1/2"), "Fmhalf", (func_t)gsl_sf_fermi_dirac_mhalf, 1, FunctionGroups::FermiDiracFunction},
	{i18n("Complete Fermi-Dirac integral with index 1/2"), "Fhalf", (func_t)gsl_sf_fermi_dirac_half, 1, FunctionGroups::FermiDiracFunction},
	...
	{i18n("Logarithm naturalis of the gamma function"), "lngamma", (func_t)gsl_sf_lngamma, 1, FunctionGroups::GammaAndBetaFunctions},
	{i18n("Regulated gamma function"), "gammastar", (func_t)gsl_sf_gammastar, 1, FunctionGroups::GammaAndBetaFunctions},
	{i18n("Reciprocal of the gamma function"), "gammainv", (func_t)gsl_sf_gammainv, 1, FunctionGroups::GammaAndBetaFunctions},
	{i18n("Factorial n!"), "fact", (func_t)nsl_sf_fact, 1, FunctionGroups::GammaAndBetaFunctions},
	{i18n("Double factorial n!!"), "doublefact", (func_t)nsl_sf_doublefact, 1, FunctionGroups::GammaAndBetaFunctions},
	{i18n("Logarithm of the factorial"), "lnfact", (func_t)nsl_sf_lnfact, 1, FunctionGroups::GammaAndBetaFunctions},
	{i18n("Logarithm of the double factorial"), "lndoublefact", (func_t)nsl_sf_lndoublefact, 1, FunctionGroups::GammaAndBetaFunctions},

	{i18n("Combinatorial factor"), "choose", (func_t)nsl_sf_choose, 2, FunctionGroups::GammaAndBetaFunctions},
	{i18n("Logarithm of the combinatorial factor"), "lnchoose", (func_t)nsl_sf_lnchoose, 2, FunctionGroups::GammaAndBetaFunctions},
	{i18n("Taylor coefficient"), "taylor", (func_t)nsl_sf_taylorcoeff, 2, FunctionGroups::GammaAndBetaFunctions},
	{i18n("Pochhammer symbol"), "poch", (func_t)gsl_sf_poch, 2, FunctionGroups::GammaAndBetaFunctions},
	{i18n("Logarithm of the Pochhammer symbol"), "lnpoch", (func_t)gsl_sf_lnpoch, 2, FunctionGroups::GammaAndBetaFunctions},
	{i18n("Relative Pochhammer symbol"), "pochrel", (func_t)gsl_sf_pochrel, 2, FunctionGroups::GammaAndBetaFunctions},
	{i18n("Unnormalized incomplete gamma function"), "gammainc", (func_t)gsl_sf_gamma_inc, 2, FunctionGroups::GammaAndBetaFunctions},
	{i18n("Normalized incomplete gamma function"), "gammaincQ", (func_t)gsl_sf_gamma_inc_Q, 2, FunctionGroups::GammaAndBetaFunctions},
	{i18n("Complementary normalized incomplete gamma function"), "gammaincP", (func_t)gsl_sf_gamma_inc_P, 2, FunctionGroups::GammaAndBetaFunctions},
	{i18n("Beta function"), "beta", (func_t)gsl_sf_beta, 2, FunctionGroups::GammaAndBetaFunctions},
	...
	{i18n("Hermite functions (fast version)"), "Hfnf", (func_t)nsl_sf_hermite_func_fast, 2, FunctionGroups::HermitePolynomialsAndFunctions},
#endif
	{i18n("Derivatives of Hermite polynomials physicists version"), "Hnd", (func_t)nsl_sf_hermite_deriv, 3, FunctionGroups::HermitePolynomialsAndFunctions},
	...
	{i18n("Confluent hypergeometric function 1F1 for general parameters"), "hyperg_1F1", (func_t)gsl_sf_hyperg_1F1, 3, FunctionGroups::HypergeometricFunctions},
	{i18n("Confluent hypergeometric function U for integer parameters"), "hyperg_Ui", (func_t)nsl_sf_hyperg_Ui, 3, FunctionGroups::HypergeometricFunctions},
	{i18n("Confluent hypergeometric function U"), "hyperg_U", (func_t)gsl_sf_hyperg_U, 3, FunctionGroups::HypergeometricFunctions},
	{i18n("Gauss hypergeometric function 2F1"), "hyperg_2F1", (func_t)gsl_sf_hyperg_2F1, 4, FunctionGroups::HypergeometricFunctions},
	{i18n("Gauss hypergeometric function 2F1 with complex parameters"),
	 "hyperg_2F1c",
	 (func_t)gsl_sf_hyperg_2F1_conj,
	 4,
	 FunctionGroups::HypergeometricFunctions},
	{i18n("Renormalized Gauss hypergeometric function 2F1"), "hyperg_2F1r", (func_t)gsl_sf_hyperg_2F1_renorm, 4, FunctionGroups::HypergeometricFunctions},
	...
	{i18n("Legendre polynomial P_l"), "Pl", (func_t)nsl_sf_legendre_Pl, 2, FunctionGroups::LegendreFunctionsAndSphericalHarmonics},
	{i18n("Legendre function Q_0"), "Q0", (func_t)gsl_sf_legendre_Q0, 1, FunctionGroups::LegendreFunctionsAndSphericalHarmonics},
	{i18n("Legendre function Q_1"), "Q1", (func_t)gsl_sf_legendre_Q1, 1, FunctionGroups::LegendreFunctionsAndSphericalHarmonics},
	{i18n("Legendre function Q_l"), "Ql", (func_t)nsl_sf_legendre_Ql, 2, FunctionGroups::LegendreFunctionsAndSphericalHarmonics},
	{i18n("Associated Legendre polynomial"), "Plm", (func_t)nsl_sf_legendre_Plm, 3, FunctionGroups::LegendreFunctionsAndSphericalHarmonics},
	{i18n("Normalized associated Legendre polynomial"), "Pslm", (func_t)nsl_sf_legendre_sphPlm, 3, FunctionGroups::LegendreFunctionsAndSphericalHarmonics},
	{i18n("Irregular spherical conical function P^1/2"), "Phalf", (func_t)gsl_sf_conicalP_half, 2, FunctionGroups::LegendreFunctionsAndSphericalHarmonics},

	{i18n("Regular spherical conical function P^(-1/2)"), "Pmhalf", (func_t)gsl_sf_conicalP_mhalf, 2, FunctionGroups::LegendreFunctionsAndSphericalHarmonics},
	{i18n("Conical function P^0"), "Pc0", (func_t)gsl_sf_conicalP_0, 2, FunctionGroups::LegendreFunctionsAndSphericalHarmonics},
	{i18n("Conical function P^1"), "Pc1", (func_t)gsl_sf_conicalP_1, 2, FunctionGroups::LegendreFunctionsAndSphericalHarmonics},
	{i18n("Regular spherical conical function P^(-1/2-l)"), "Psr", (func_t)nsl_sf_conicalP_sphreg, 3, FunctionGroups::LegendreFunctionsAndSphericalHarmonics},
	{i18n("Regular cylindrical conical function P^(-m)"), "Pcr", (func_t)nsl_sf_conicalP_cylreg, 3, FunctionGroups::LegendreFunctionsAndSphericalHarmonics},
	...
	{i18n("Angular Mathieu functions se_n(q,x)"), "se", (func_t)nsl_sf_mathieu_se, 3, FunctionGroups::MathieuFunctions},
	{i18n("Radial j-th kind Mathieu functions Mc_n^{(j)}(q,x)"), "Mc", (func_t)nsl_sf_mathieu_Mc, 4, FunctionGroups::MathieuFunctions},
	...
	{i18n("Trigamma function psi' for positive integer n"), "psi1int", (func_t)nsl_sf_psi1int, 1, FunctionGroups::PsiDigammaFunction},
	...
	{i18n("Inverse sine"), "asin", (func_t) static_cast<double (*)(double)>(&asin), 1, FunctionGroups::TrigonometricFunctions},
	{i18n("Inverse cosine"), "acos", (func_t) static_cast<double (*)(double)>(&acos), 1, FunctionGroups::TrigonometricFunctions},
	{i18n("Inverse tangent"), "atan", (func_t) static_cast<double (*)(double)>(&atan), 1, FunctionGroups::TrigonometricFunctions},
	{i18n("Inverse tangent using sign"), "atan2", (func_t) static_cast<double (*)(double, double)>(&atan2), 2, FunctionGroups::TrigonometricFunctions},
	{i18n("Hyperbolic sine"), "sinh", (func_t) static_cast<double (*)(double)>(&sinh), 1, FunctionGroups::TrigonometricFunctions},
	{i18n("Hyperbolic cosine"), "cosh", (func_t) static_cast<double (*)(double)>(&cosh), 1, FunctionGroups::TrigonometricFunctions},
	{i18n("Hyperbolic tangent"), "tanh", (func_t) static_cast<double (*)(double)>(&tanh), 1, FunctionGroups::TrigonometricFunctions},
	{i18n("Inverse hyperbolic cosine"), "acosh", (func_t)gsl_acosh, 1, FunctionGroups::TrigonometricFunctions},
	{i18n("Inverse hyperbolic sine"), "asinh", (func_t)gsl_asinh, 1, FunctionGroups::TrigonometricFunctions},
	{i18n("Inverse hyperbolic tangent"), "atanh", (func_t)gsl_atanh, 1, FunctionGroups::TrigonometricFunctions},
	{i18n("Secant"), "sec", (func_t)nsl_sf_sec, 1, FunctionGroups::TrigonometricFunctions},
	{i18n("Cosecant"), "csc", (func_t)nsl_sf_csc, 1, FunctionGroups::TrigonometricFunctions},
	{i18n("Cotangent"), "cot", (func_t)nsl_sf_cot, 1, FunctionGroups::TrigonometricFunctions},
	{i18n("Inverse secant"), "asec", (func_t)nsl_sf_asec, 1, FunctionGroups::TrigonometricFunctions},
	{i18n("Inverse cosecant"), "acsc", (func_t)nsl_sf_acsc, 1, FunctionGroups::TrigonometricFunctions},
	{i18n("Inverse cotangent"), "acot", (func_t)nsl_sf_acot, 1, FunctionGroups::TrigonometricFunctions},
	{i18n("Hyperbolic secant"), "sech", (func_t)nsl_sf_sech, 1, FunctionGroups::TrigonometricFunctions},
	{i18n("Hyperbolic cosecant"), "csch", (func_t)nsl_sf_csch, 1, FunctionGroups::TrigonometricFunctions},
	{i18n("Hyperbolic cotangent"), "coth", (func_t)nsl_sf_coth, 1, FunctionGroups::TrigonometricFunctions},
	{i18n("Inverse hyperbolic secant"), "asech", (func_t)nsl_sf_asech, 1, FunctionGroups::TrigonometricFunctions},
	{i18n("Inverse hyperbolic cosecant"), "acsch", (func_t)nsl_sf_acsch, 1, FunctionGroups::TrigonometricFunctions},
	{i18n("Inverse hyperbolic cotangent"), "acoth", (func_t)nsl_sf_acoth, 1, FunctionGroups::TrigonometricFunctions},
	{i18n("Sinc function sin(x)/x"), "sinc", (func_t)gsl_sf_sinc, 1, FunctionGroups::TrigonometricFunctions},
	{QStringLiteral("log(sinh(x))"), "logsinh", (func_t)gsl_sf_lnsinh, 1, FunctionGroups::TrigonometricFunctions},
	{QStringLiteral("log(cosh(x))"), "logcosh", (func_t)gsl_sf_lncosh, 1, FunctionGroups::TrigonometricFunctions},
	{i18n("Hypotenuse function"), "hypot", (func_t)gsl_sf_hypot, 2, FunctionGroups::TrigonometricFunctions},
	{i18n("Three component hypotenuse function"), "hypot3", (func_t)gsl_hypot3, 3, FunctionGroups::TrigonometricFunctions},
	...
	{i18n("zeta(x)-1"), "zetam1", (func_t)gsl_sf_zetam1, 1, FunctionGroups::ZetaFunctions},
	{i18n("Hurwitz zeta function"), "hzeta", (func_t)gsl_sf_hzeta, 2, FunctionGroups::ZetaFunctions},
	{i18n("Eta function for integer n"), "etaint", (func_t)nsl_sf_etaint, 1, FunctionGroups::ZetaFunctions},
	...
	{i18n("Cauchy/Lorentz random numbers"), "randcauchy", (func_t)nsl_sf_ran_cauchy, 1, FunctionGroups::RandomNumberGenerator},
	{i18n("Rayleigh random numbers"), "randrayleigh", (func_t)nsl_sf_ran_rayleigh, 1, FunctionGroups::RandomNumberGenerator},
	{i18n("Landau random numbers"), "randlandau", (func_t)nsl_sf_ran_landau, 0, FunctionGroups::RandomNumberGenerator},
	{i18n("Levy alpha-stable random numbers"), "randlevy", (func_t)nsl_sf_ran_levy, 2, FunctionGroups::RandomNumberGenerator},
	{i18n("Gamma random numbers"), "randgamma", (func_t)nsl_sf_ran_gamma, 2, FunctionGroups::RandomNumberGenerator},
	{i18n("Flat random numbers"), "randflat", (func_t)nsl_sf_ran_flat, 2, FunctionGroups::RandomNumberGenerator},
	{i18n("Lognormal random numbers"), "randlognormal", (func_t)nsl_sf_ran_lognormal, 2, FunctionGroups::RandomNumberGenerator},

	{i18n("Chi-squared random numbers"), "randchisq", (func_t)nsl_sf_ran_chisq, 1, FunctionGroups::RandomNumberGenerator},
	{i18n("t-distributed random numbers"), "randtdist", (func_t)nsl_sf_ran_tdist, 1, FunctionGroups::RandomNumberGenerator},
	{i18n("Logistic random numbers"), "randlogistic", (func_t)nsl_sf_ran_logistic, 1, FunctionGroups::RandomNumberGenerator},
	{i18n("Poisson random numbers"), "randpoisson", (func_t)nsl_sf_ran_poisson, 1, FunctionGroups::RandomNumberGenerator},
	{i18n("Bernoulli random numbers"), "randbernoulli", (func_t)nsl_sf_ran_bernoulli, 1, FunctionGroups::RandomNumberGenerator},
	...
	{i18n("Cumulative distribution function Q"), "gaussianQ", (func_t)gsl_cdf_gaussian_Q, 2, FunctionGroups::GaussianDistribution},
	{i18n("Inverse cumulative distribution function P"), "gaussianPinv", (func_t)gsl_cdf_gaussian_Pinv, 2, FunctionGroups::GaussianDistribution},
	{i18n("Inverse cumulative distribution function Q"), "gaussianQinv", (func_t)gsl_cdf_gaussian_Qinv, 2, FunctionGroups::GaussianDistribution},
	{i18n("Cumulative unit distribution function P"), "ugaussianP", (func_t)gsl_cdf_ugaussian_P, 1, FunctionGroups::GaussianDistribution},
	{i18n("Cumulative unit distribution function Q"), "ugaussianQ", (func_t)gsl_cdf_ugaussian_Q, 1, FunctionGroups::GaussianDistribution},
	{i18n("Inverse cumulative unit distribution function P"), "ugaussianPinv", (func_t)gsl_cdf_ugaussian_Pinv, 1, FunctionGroups::GaussianDistribution},
	{i18n("Inverse cumulative unit distribution function Q"), "ugaussianQinv", (func_t)gsl_cdf_ugaussian_Qinv, 1, FunctionGroups::GaussianDistribution},

	{i18n("Probability density for Gaussian tail distribution"), "gaussiantail", (func_t)gsl_ran_gaussian_tail_pdf, 3, FunctionGroups::GaussianDistribution},
	...
	{i18n("Inverse cumulative distribution function P"), "rayleighPinv", (func_t)gsl_cdf_rayleigh_Pinv, 2, FunctionGroups::RayleighDistribution},
	...
	{i18n("Inverse cumulative distribution function P"), "gumbel1Pinv", (func_t)gsl_cdf_gumbel1_Pinv, 3, FunctionGroups::GumbelDistribution},
	{i18n("Inverse cumulative distribution function Q"), "gumbel1Qinv", (func_t)gsl_cdf_gumbel1_Qinv, 3, FunctionGroups::GumbelDistribution},
	{i18n("Probability density for a Type-2 Gumbel distribution"), "gumbel2", (func_t)gsl_ran_gumbel2_pdf, 3, FunctionGroups::GumbelDistribution},
	{i18n("Cumulative distribution function P"), "gumbel2P", (func_t)gsl_cdf_gumbel2_P, 3, FunctionGroups::GumbelDistribution},
	{i18n("Cumulative distribution function Q"), "gumbel2Q", (func_t)gsl_cdf_gumbel2_Q, 3, FunctionGroups::GumbelDistribution},
