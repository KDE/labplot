...
#define COLUMN_FUNCTION(function_name, evaluation_function)                                                                                                    \
	double column##function_name(const std::string_view& variable, const std::weak_ptr<Parser::Payload> payload) {                                             \
...
double columnPercentile(double p, const std::string_view& variable, const std::weak_ptr<Parser::Payload> payload) {
...
void ColumnPrivate::updateFormula() {
	...
	if (valid) {
		...
		parser->setSpecialFunctionVariablePayload(Parser::colfun_size, columnSize, payload);
		parser->setSpecialFunctionVariablePayload(Parser::colfun_min, columnMin, payload);
		parser->setSpecialFunctionVariablePayload(Parser::colfun_max, columnMax, payload);
		parser->setSpecialFunctionVariablePayload(Parser::colfun_mean, columnMean, payload);
		parser->setSpecialFunctionVariablePayload(Parser::colfun_median, columnMedian, payload);
		parser->setSpecialFunctionVariablePayload(Parser::colfun_stdev, columnStdev, payload);
		parser->setSpecialFunctionVariablePayload(Parser::colfun_var, columnVar, payload);
		parser->setSpecialFunctionVariablePayload(Parser::colfun_gm, columnGm, payload);
		parser->setSpecialFunctionVariablePayload(Parser::colfun_hm, columnHm, payload);
		parser->setSpecialFunctionVariablePayload(Parser::colfun_chm, columnChm, payload);
		parser->setSpecialFunctionVariablePayload(Parser::colfun_mode, columnStatisticsMode, payload);
		parser->setSpecialFunctionVariablePayload(Parser::colfun_quartile1, columnQuartile1, payload);
		parser->setSpecialFunctionVariablePayload(Parser::colfun_quartile3, columnQuartile3, payload);
		parser->setSpecialFunctionVariablePayload(Parser::colfun_iqr, columnIqr, payload);
		parser->setSpecialFunctionVariablePayload(Parser::colfun_percentile1, columnPercentile1, payload);
		parser->setSpecialFunctionVariablePayload(Parser::colfun_percentile5, columnPercentile5, payload);
		parser->setSpecialFunctionVariablePayload(Parser::colfun_percentile10, columnPercentile10, payload);
		parser->setSpecialFunctionVariablePayload(Parser::colfun_percentile90, columnPercentile90, payload);
		parser->setSpecialFunctionVariablePayload(Parser::colfun_percentile95, columnPercentile95, payload);
		parser->setSpecialFunctionVariablePayload(Parser::colfun_percentile99, columnPercentile99, payload);
		parser->setSpecialFunctionVariablePayload(Parser::colfun_trimean, columnTrimean, payload);
		parser->setSpecialFunctionVariablePayload(Parser::colfun_meandev, columnMeandev, payload);
		parser->setSpecialFunctionVariablePayload(Parser::colfun_meandevmedian, columnMeandevmedian, payload);
		parser->setSpecialFunctionVariablePayload(Parser::colfun_mediandev, columnMediandev, payload);
		parser->setSpecialFunctionVariablePayload(Parser::colfun_skew, columnSkew, payload);
		parser->setSpecialFunctionVariablePayload(Parser::colfun_kurt, columnKurt, payload);
