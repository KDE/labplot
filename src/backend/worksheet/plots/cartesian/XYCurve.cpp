...
void XYCurve::loadConfig(const KConfig& config)
{
    ...
    //Drop line
    this->dropLinePen().setColor(group.readEntry("DropLineColor",(QColor) this->dropLinePen().color()));
    this->dropLinePen().setStyle((Qt::PenStyle)group.readEntry("DropLineStyle",(int) this->dropLinePen().style()));
    this->dropLinePen().setWidthF(group.readEntry("DropLineWidth", this->dropLinePen().widthF()));
    ...
    this->errorBarsPen().setColor(group.readEntry("ErrorBarsColor",(QColor) this->errorBarsPen().color()));
    this->errorBarsPen().setStyle((Qt::PenStyle)group.readEntry("ErrorBarsStyle",(int) this->errorBarsPen().style()));
    this->errorBarsPen().setWidthF(group.readEntry("ErrorBarsWidth", this->errorBarsPen().widthF()));
