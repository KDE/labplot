...
public:
	...
	void updateLines();
	void addLine(QPointF p, double& x, double& minY, double& maxY, QPointF& lastPoint, int& pixelDiff, int numberOfPixelX, double minLogicalDiffX, RangeT::Scale scale); // for any x scale
