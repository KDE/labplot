...
void SettingsWorksheetPage::applySettings() {
	...
	KConfigGroup group = Settings::config()->group(QLatin1String("Settings_Worksheet"));
...
void SettingsWorksheetPage::loadSettings() {
	const KConfigGroup group = Settings::config()->group(QLatin1String("Settings_Worksheet"));
