...
void MainWin::initActions() {
	...
	m_newWorkbookAction = new KAction(KIcon("workbook"),i18n("Workbook"),this);
	actionCollection()->addAction("new_workbook", m_newWorkbookAction);
	connect(m_newWorkbookAction, SIGNAL(triggered()),SLOT(newWorkbook()));

	m_newSpreadsheetAction = new KAction(KIcon("spreadsheet"),i18n("Spreadsheet"),this);
// 	m_newSpreadsheetAction->setShortcut(Qt::CTRL+Qt::Key_Equal);
	...
	m_newMatrixAction = new KAction(KIcon("matrix"),i18n("Matrix"),this);
// 	m_newMatrixAction->setShortcut(Qt::CTRL+Qt::Key_Equal);
	...
	m_newWorksheetAction= new KAction(KIcon("worksheet"),i18n("Worksheet"),this);
