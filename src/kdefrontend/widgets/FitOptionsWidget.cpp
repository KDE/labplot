...
// 	ui.cbRobust->addItem(i18n("off"));
	...
	connect( ui.cbAutoRange, SIGNAL(clicked(bool)), this, SLOT(autoRangeChanged()));
	connect( ui.sbMin, SIGNAL(valueChanged(double)), this, SLOT(xRangeMinChanged()));
	connect( ui.sbMax, SIGNAL(valueChanged(double)), this, SLOT(xRangeMaxChanged()));
