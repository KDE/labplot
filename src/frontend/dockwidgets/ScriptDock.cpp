...
ScriptDock::ScriptDock(QWidget* parent)
	...
	connect(m_caseSensitiveAction, &QAction::triggered, this, [=, this]() {filterTextChanged(ui.leFilter->text());});
	connect(m_matchCompleteWordAction, &QAction::triggered, this, [=, this]() {filterTextChanged(ui.leFilter->text());});
