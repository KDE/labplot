...
#include "frontend/dockwidgets/BoxPlotDock.h"
#include "frontend/dockwidgets/CartesianPlotDock.h"
#include "frontend/dockwidgets/CartesianPlotLegendDock.h"
...
#include "frontend/dockwidgets/XYHilbertTransformCurveDock.h"
#include "frontend/dockwidgets/XYIntegrationCurveDock.h"
#include "frontend/dockwidgets/XYInterpolationCurveDock.h"
#include "frontend/dockwidgets/XYSmoothCurveDock.h"
#ifdef HAVE_CANTOR_LIBS
...
void GuiObserver::selectedAspectsChanged(const QList<AbstractAspect*>& selectedAspects) {
	...
	case AspectType::Bar3DPlot:
		...
		break;
	case AspectType::Plot3DArea:
		m_mainWindow->m_propertiesDock->setWindowTitle(i18nc("@title:window", "Plot Area 3D"));
		raiseDock(m_plot3DAreaDock, m_mainWindow->stackedWidget);
		m_plot3DAreaDock->setPlots(castList<Plot3DArea>(selectedAspects));
		break;
