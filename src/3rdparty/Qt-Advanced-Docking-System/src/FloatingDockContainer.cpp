	...
	d(new FloatingDockContainerPrivate(this))
{
	...
	else
	{
		...
		QString window_manager = internal::windowManager().toUpper().split(QLatin1String(" "))[0];
                native_window = window_manager != QLatin1String("KWIN");
	}
    ...
    if (native_window)
    {
        ...
        if (QLatin1String("wayland") == XdgSessionType)
        {
            native_window = false;
        }
    }
