...
filter.readDataFromFile("lib/examples/Hertzsprung-Russel Diagram/HYG_data.txt", spreadsheet, AbstractFileFilter.ImportMode.Replace)
...
filter2.readDataFromFile("lib/examples/Hertzsprung-Russel Diagram/temp_to_ci_mapping.txt", spreadsheet2, AbstractFileFilter.ImportMode.Replace)
...
textLabel.setPositionScene(QPointF(Worksheet.convertToSceneUnits(-1.8, Worksheet.Unit.Centimeter), Worksheet.convertToSceneUnits(-8.7, Worksheet.Unit.Centimeter)))

textLabel1 = TextLabel("Main Sequence")
textLabel1.setText("Main Sequence")
worksheet.addChild(textLabel1)
textLabel1.setPositionScene(QPointF(Worksheet.convertToSceneUnits(6.3, Worksheet.Unit.Centimeter), Worksheet.convertToSceneUnits(-6.8, Worksheet.Unit.Centimeter)))

textLabel2 = TextLabel("Giants")
textLabel2.setText("Giants")
worksheet.addChild(textLabel2)
textLabel2.setPositionScene(QPointF(Worksheet.convertToSceneUnits(5.4, Worksheet.Unit.Centimeter), Worksheet.convertToSceneUnits(2.1, Worksheet.Unit.Centimeter)))

textLabel3 = TextLabel("Super Giants")
textLabel3.setText("Super Giants")
worksheet.addChild(textLabel3)
textLabel3.setPositionScene(QPointF(Worksheet.convertToSceneUnits(5.5, Worksheet.Unit.Centimeter), Worksheet.convertToSceneUnits(7.5, Worksheet.Unit.Centimeter)))
