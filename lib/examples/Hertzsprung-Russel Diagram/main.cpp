...
int main(int argc, char* argv[]) {
    ...
    auto* spreadsheet = new Spreadsheet("HYG data");
    ...
    auto* spreadsheet2 = new Spreadsheet("temp to ci mapping");
    ...
    auto* textLabel = new TextLabel("White Dwarfs");
    ...
    auto* textLabel1 = new TextLabel("Main Sequence");
    ...
    auto* textLabel2 = new TextLabel("Giants");
    ...
    auto* textLabel3 = new TextLabel("Super Giants");
