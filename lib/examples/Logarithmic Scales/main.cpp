...
int main(int argc, char* argv[]) {
    ...
    auto* config11 = new XYEquationCurve("f(x)=10^x");
    ...
    auto* config12 = new XYEquationCurve("f(x)=x");
    ...
    auto* config13 = new XYEquationCurve("f(x)=log(x)");
    ...
    auto* config21 = new XYEquationCurve("f(x)=10^x");
    ...
    auto* config22 = new XYEquationCurve("f(x)=x");
    ...
    auto* config23 = new XYEquationCurve("f(x)=log(x)");
    ...
    auto* config31 = new XYEquationCurve("f(x)=10^x");
    ...
    auto* config32 = new XYEquationCurve("f(x)=x");
    ...
    auto* config33 = new XYEquationCurve("f(x)=log(x)");
    ...
    auto* config41 = new XYEquationCurve("f(x)=10^x");
    ...
    auto* config42 = new XYEquationCurve("f(x)=x");
    ...
    auto* config43 = new XYEquationCurve("f(x)=log(x)");
