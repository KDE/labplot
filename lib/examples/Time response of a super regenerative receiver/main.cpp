...
int main(int argc, char* argv[]) {
    ...
    CartesianPlot plotArea("Response plot");
    ...
    XYCurve config1("Received pulse (x100)");
    ...
    XYHilbertTransformCurve config3("Envelope");
    ...
    ReferenceLine rl1(&plotArea, QStringLiteral("MaxTimeLine"));
    ...
    ReferenceLine rl2(&plotArea, QStringLiteral("MaxAmpLine"));
    ...
    TextLabel textLabel1("MaxAmpText");
    ...
    TextLabel textLabel2("MaxTimeText");
