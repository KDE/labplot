...
filter1.readDataFromFile("Same Data Different Boxplots/data.txt", spreadsheet1, AbstractFileFilter.ImportMode.Replace)
...
filter2.readDataFromFile("Same Data Different Boxplots/labels.txt", spreadsheet2, AbstractFileFilter.ImportMode.Replace)
