...
int main(int argc, char* argv[]) {
    ...
    auto* worksheet = new Worksheet("Standard vs. Tufte's Minimal Ink Design");
    ...
    auto* plotArea1 = new CartesianPlot("Scatterplot - Standard");
    ...
    auto* plotArea2 = new CartesianPlot("Histograms - Standard");
    ...
    auto* config21 = new Histogram("config21");
    ...
    auto* config22 = new Histogram("config22");
    ...
    auto* plotArea3 = new CartesianPlot("Boxplots - Standard");
    ...
    auto* config31 = new BoxPlot("config31");
    ...
    auto* plotArea4 = new CartesianPlot("Scatterplot - Tufte");
    ...
    auto* config4 = new XYCurve("config4");
    ...
    auto* plotArea5 = new CartesianPlot("Histograms - Tufte");
    ...
    auto* config51 = new Histogram("config51");
    ...
    auto* config52 = new Histogram("config52");
    ...
    auto* plotArea6 = new CartesianPlot("Boxplots - Tufte");
    ...
    auto* config61 = new BoxPlot("config61");
    ...
    auto* textLabel1 = new TextLabel("Tufte's Minimal Ink Design");
    ...
    auto* textLabel2 = new TextLabel("Standard Design");
