...
filter.readDataFromFile("NIST - Linear Regression/norris_data.txt", spreadsheet, AbstractFileFilter.ImportMode.Replace)
...
filter2.readDataFromFile("NIST - Linear Regression/pontius_data.txt", spreadsheet2, AbstractFileFilter.ImportMode.Replace)
...
filter3.readDataFromFile("NIST - Linear Regression/noint1_data.txt", spreadsheet3, AbstractFileFilter.ImportMode.Replace)
...
filter4.readDataFromFile("NIST - Linear Regression/noint2_data.txt", spreadsheet4, AbstractFileFilter.ImportMode.Replace)
