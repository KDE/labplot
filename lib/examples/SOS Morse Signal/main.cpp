...
int main(int argc, char* argv[]) {
    ...
    CartesianPlot plotArea1("Signal with noise");
    ...
    XYFourierTransformCurve config21("Fourier transform");
    ...
    CartesianPlot plotArea3("Signal after Fourier Filter");
    ...
    XYFourierFilterCurve config31("Fourier filter");
    ...
    TextLabel textLabel1("Signal Info");
    ...
    TextLabel textLabel3("Fourier Filter Info");
