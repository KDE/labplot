...
filter1.readDataFromFile("Multi-Ranges/IPCE.txt", spreadsheet1, AbstractFileFilter.ImportMode.Replace)
...
filter2.readDataFromFile("Multi-Ranges/Current.txt", spreadsheet2, AbstractFileFilter.ImportMode.Replace)
...
plotArea1.setBorderType(border)
...
config32.value().setType(Value.Type.NoValues)
