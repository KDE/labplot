...
int main(int argc, char* argv[]) {
	...
	auto* spreadsheet1 = new Spreadsheet("IPCE");
	...
	auto* spreadsheet2 = new Spreadsheet("Current");
    ...
    auto* worksheet1 = new Worksheet("single-range demo");
    ...
    auto* plotArea1 = new CartesianPlot("IPCE1");
    ...
    auto* config11 = new XYCurve("IPCE");
    ...
    auto* config12 = new XYCurve("Current Density");
    ...
    auto* worksheet2 = new Worksheet("multi-range demo");
    ...
    auto* plotArea2 = new CartesianPlot("IPCE2");
    ...
    auto* config21 = new XYCurve("IPCE");
    ...
    auto* config22 = new XYCurve("Current Density");
    ...
    auto* worksheet3 = new Worksheet("multi-range demo, alternative");
    ...
    auto* plotArea3 = new CartesianPlot("IPCE3");
    ...
    auto* config31 = new XYCurve("IPCE");
    ...
    auto* config32 = new XYCurve("Current Density");
