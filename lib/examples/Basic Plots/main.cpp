...
int main(int argc, char* argv[]) {
    ...
    auto* plotArea1 = new CartesianPlot("Plot - Spreadsheet");
    ...
    auto* config11 = new Histogram("Lognormal(1,1)");
    ...
    auto* fit11 = new XYFitCurve ("Distribution Fit to 'Lognormal(1,1)'");
    ...
    auto* config12 = new Histogram("Normal(0,1)");
    ...
    auto* fit12 = new XYFitCurve("Distribution Fit to 'Normal(0,1)'");
    ...
    auto* plotArea2 = new CartesianPlot("Plot - Spreadsheet 1");
    ...
    auto* config2 = new BoxPlot("config2");
    ...
    auto* plotArea3 = new CartesianPlot("Plot - Spreadsheet 2");
    ...
    auto* config31 = new XYCurve("Normal(-1,2)");
    ...
    auto* config32 = new XYCurve("Normal(0,1)");
