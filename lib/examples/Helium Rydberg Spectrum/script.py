...
filter.readDataFromFile("lib/examples/Helium Rydberg Spectrum/data.txt", spreadsheet, AbstractFileFilter.ImportMode.Replace)
...
config3.value().setType(Value.Type.NoValues)
...
infoElement.title().setPositionScene(QPointF(Worksheet.convertToSceneUnits(4.6, Worksheet.Unit.Centimeter),Worksheet.convertToSceneUnits(1.3, Worksheet.Unit.Centimeter)))
