...
filter.readDataFromFile("lib/examples/Anatomy of a BoxPlot/data.txt", spreadsheet, AbstractFileFilter.ImportMode.Replace)
...
textLabel2.setPositionScene(QPointF(Worksheet.convertToSceneUnits(0, Worksheet.Unit.Centimeter), Worksheet.convertToSceneUnits(-2.1, Worksheet.Unit.Centimeter)))
...
textLabel3.setPositionScene(QPointF(Worksheet.convertToSceneUnits(1.5, Worksheet.Unit.Centimeter), Worksheet.convertToSceneUnits(-1, Worksheet.Unit.Centimeter)))
...
textLabel4.setPositionScene(QPointF(Worksheet.convertToSceneUnits(1.7, Worksheet.Unit.Centimeter), Worksheet.convertToSceneUnits(-2.5, Worksheet.Unit.Centimeter)))
...
textLabel5.setPositionScene(QPointF(Worksheet.convertToSceneUnits(1.8, Worksheet.Unit.Centimeter), Worksheet.convertToSceneUnits(-0.4, Worksheet.Unit.Centimeter)))

textLabel6 = TextLabel("Median")
worksheet.addChild(textLabel6)
te.setPlainText("Median")
textLabel6.setText(te.toHtml())
textLabel6.setPositionScene(QPointF(Worksheet.convertToSceneUnits(1.2, Worksheet.Unit.Centimeter), Worksheet.convertToSceneUnits(0.6, Worksheet.Unit.Centimeter)))

textLabel7 = TextLabel("3rd Quartile")
worksheet.addChild(textLabel7)
te.setPlainText("3rd Quartile")
textLabel7.setText(te.toHtml())
textLabel7.setPositionScene(QPointF(Worksheet.convertToSceneUnits(1.4, Worksheet.Unit.Centimeter), Worksheet.convertToSceneUnits(0.9, Worksheet.Unit.Centimeter)))

textLabel8 = TextLabel("1st Quartile")
worksheet.addChild(textLabel8)
te.setPlainText("1st Quartile")
textLabel8.setText(te.toHtml())
textLabel8.setPositionScene(QPointF(Worksheet.convertToSceneUnits(1.4, Worksheet.Unit.Centimeter), Worksheet.convertToSceneUnits(0.4, Worksheet.Unit.Centimeter)))
...
textLabel9.setPositionScene(QPointF(Worksheet.convertToSceneUnits(1.8, Worksheet.Unit.Centimeter), Worksheet.convertToSceneUnits(1.7, Worksheet.Unit.Centimeter)))
...
textLabel10.setPositionScene(QPointF(Worksheet.convertToSceneUnits(0, Worksheet.Unit.Centimeter), Worksheet.convertToSceneUnits(1.9, Worksheet.Unit.Centimeter)))
...
textLabel11.setPositionScene(QPointF(Worksheet.convertToSceneUnits(0, Worksheet.Unit.Centimeter), Worksheet.convertToSceneUnits(2.8, Worksheet.Unit.Centimeter)))
...
textLabel12.setPositionScene(QPointF(Worksheet.convertToSceneUnits(1.6, Worksheet.Unit.Centimeter), Worksheet.convertToSceneUnits(3.2, Worksheet.Unit.Centimeter)))
...
textLabel13.setPositionScene(QPointF(Worksheet.convertToSceneUnits(1.5, Worksheet.Unit.Centimeter), Worksheet.convertToSceneUnits(2.3, Worksheet.Unit.Centimeter)))
...
textLabel14.setPositionScene(QPointF(Worksheet.convertToSceneUnits(1.5, Worksheet.Unit.Centimeter), Worksheet.convertToSceneUnits(1.3, Worksheet.Unit.Centimeter)))
...
textLabel15.setPositionScene(QPointF(Worksheet.convertToSceneUnits(1.5, Worksheet.Unit.Centimeter), Worksheet.convertToSceneUnits(0, Worksheet.Unit.Centimeter)))
