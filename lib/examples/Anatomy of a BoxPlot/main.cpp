...
int main(int argc, char* argv[]) {
    ...
    auto* worksheet = new Worksheet("Anatomy of a Box Plot");
    ...
    auto* plotArea = new CartesianPlot("Plot");
    ...
    auto* textLabel1 = new TextLabel("Lower inner fence - label");
    ...
    auto* textLabel3 = new TextLabel("Lower outliers - label");
    ...
    auto* textLabel4 = new TextLabel("Lower far outliers - label");
    ...
    auto* textLabel5 = new TextLabel("Lower adjacent value - label");
    ...
    auto* textLabel6 = new TextLabel("Median");
    ...
    auto* textLabel7 = new TextLabel("3rd Quartile");
    ...
    auto* textLabel8 = new TextLabel("1st Quartile");
    ...
    auto* textLabel9 = new TextLabel("Upper adjacent value - label");
    ...
    auto* textLabel10 = new TextLabel("Upper inner fence - label");
    ...
    auto* textLabel11 = new TextLabel("Upper outer fence - label");
    ...
    auto* textLabel12 = new TextLabel("Upper far outliers - label");
    ...
    auto* textLabel13 = new TextLabel("Upper outliers");
    ...
    auto* textLabel14 = new TextLabel("Upper whisker - label");
    ...
    auto* textLabel15 = new TextLabel("Lower whisker - label");
    ...
    auto* rl1 = new ReferenceLine(plotArea, QStringLiteral("Lower inner fence"));
    ...
    auto* rl2 = new ReferenceLine(plotArea, QStringLiteral("Lower outer fence"));
    ...
    auto* rl3 = new ReferenceLine(plotArea, QStringLiteral("Upper inner fence"));
    ...
    auto* rl4 = new ReferenceLine(plotArea, QStringLiteral("Upper outer fence"));
