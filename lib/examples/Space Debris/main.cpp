...
int main(int argc, char* argv[]) {
	...
	auto* spreadsheet2 = new Spreadsheet("data");
	...
	auto* spreadsheet3 = new Spreadsheet("data");
    ...
    auto* worksheet = new Worksheet("Plot");
    ...
    auto* config21 = new XYCurve("xy-curve");
    ...
    auto* rl21 = new ReferenceLine(plotArea2, QStringLiteral("reference line"));
    ...
    auto* rl22 = new ReferenceLine(plotArea2, QStringLiteral("reference line 1"));
    ...
    auto* plotArea3 = new CartesianPlot("xy-plot 1");
    ...
    auto* config31 = new XYCurve("xy-curve");
