...
filter1.readDataFromFile("Space Debris/Breakups.txt", spreadsheet1, AbstractFileFilter.ImportMode.Replace)
...
filter2.readDataFromFile("Space Debris/LEO.txt", spreadsheet2, AbstractFileFilter.ImportMode.Replace)
...
filter3.readDataFromFile("Space Debris/GEO.txt", spreadsheet3, AbstractFileFilter.ImportMode.Replace)
