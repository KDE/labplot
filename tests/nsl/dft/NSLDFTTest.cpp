...
void NSLDFTTest::testOnesided_real() {
	...
	const double result[] = {10, 2, -5.85410196624968, 2, 0.854101966249685};
...
void NSLDFTTest::testOnesided_imag() {
	double data[] = {1, 1, 3, 3, 1, -1, 0, 1, 1, 0};
	const double result[] = {0, -4.97979656976556, 0, 0.449027976579585, 0};
...
void NSLDFTTest::testOnesided_magnitude() {
	double data[] = {1, 1, 3, 3, 1, -1, 0, 1, 1, 0};
	const double result[] = {10, 5.36641163872553, 5.85410196624968, 2.04978684837013, 0.854101966249685};
...
void NSLDFTTest::testOnesided_amplitude() {
	double data[] = {1, 1, 3, 3, 1, -1, 0, 1, 1, 0};
	const double result[] = {1, 1.07328232774511, 1.17082039324994, 0.409957369674026, 0.170820393249937};
...
void NSLDFTTest::testOnesided_power() {
	double data[] = {1, 1, 3, 3, 1, -1, 0, 1, 1, 0};
	const double result[] = {10, 5.75967477524977, 6.85410196624968, 0.840325224750231, 0.145898033750316};
...
void NSLDFTTest::testOnesided_phase() {
	double data[] = {1, 1, 3, 3, 1, -1, 0, 1, 1, 0};
	const double result[] = {0, 1.18889174012102, -3.14159265358979, -0.220851801285041, 0};
...
void NSLDFTTest::testOnesided_dB() {
	double data[] = {1, 1, 3, 3, 1, -1, 0, 1, 1, 0};
	const double result[] = {0, 0.614279569861449, 1.36980556663896, -7.7452260401377, -15.3492056533593};
...
void NSLDFTTest::testOnesided_squaremagnitude() {
	double data[] = {1, 1, 3, 3, 1, -1, 0, 1, 1, 0};
	const double result[] = {100, 28.7983738762488, 34.2705098312484, 4.20162612375116, 0.729490168751578};
...
void NSLDFTTest::testOnesided_squareamplitude() {
	double data[] = {1, 1, 3, 3, 1, -1, 0, 1, 1, 0};
	const double result[] = {1, 1.15193495504995, 1.37082039324994, 0.168065044950046, 0.0291796067500631};
...
void NSLDFTTest::testOnesided_normdB() {
	double data[] = {1, 1, 3, 3, 1, -1, 0, 1, 1, 0};
	const double result[] = {-1.36980556663896, -0.755525996777514, 0, -9.11503160677666, -16.7190112199983};
...
void NSLDFTTest::testTwosided_real() {
	double data[] = {1, 1, 3, 3, 1, -1, 0, 1, 1, 0};
	const double result[] = {10, 2, -5.85410196624968, 2, 0.854101966249685, 2, 0.854101966249685, 2, -5.85410196624968, 2};
...
void NSLDFTTest::testTwosided_imag() {
	double data[] = {1, 1, 3, 3, 1, -1, 0, 1, 1, 0};
	const double result[] = {0, -4.97979656976556, 0, 0.449027976579585, 0, 0, 0, -0.449027976579585, 0, 4.97979656976556};
...
void NSLDFTTest::testTwosided_phase() {
	double data[] = {1, 1, 3, 3, 1, -1, 0, 1, 1, 0};
	const double result[] = {0, 1.18889174012102, -3.14159265358979, -0.220851801285041, 0, 0, 0, 0.220851801285041, 3.14159265358979, -1.18889174012102};
...
void NSLDFTTest::testTwosided_normdB() {
	double data[] = {1, 1, 3, 3, 1, -1, 0, 1, 1, 0};
	const double result[] = {-1.36980556663896,
							 -0.755525996777514,
							 0,
							 -9.11503160677666,
							 -16.7190112199983,
