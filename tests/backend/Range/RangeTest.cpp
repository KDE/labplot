...
void RangeTest::testNiceExtend() {
	QVector< QPair<Range<double>, Range<double>> > tests{
		{{0.,.95},{0.,.96}}, {{0,.91},{0.,.96}}, {{0,.9},{0.,.9}},
		{{0.,.85},{0.,.9}}, {{0,.81},{0.,.81}}, {{0,.71},{0.,.72}},
		{{0.,.61},{0.,.63}}, {{0,.51},{0.,.54}}, {{0,.46},{0.,.48}},
		{{0,.36},{0.,.36}}, {{0,.31},{0.,.32}}, {{0.,.26},{0.,.26}},
		{{0,.21},{0.,.21}}, {{0,.19},{0.,.2}}, {{0.,.17},{0.,.175}},
		{{0,.15},{0.,.15}}
	};
	QVector< QPair<Range<double>, Range<double>> > tests2{	// QCOMPARE is too strict
		{{0.,.41},{0.,.42}}, {{0.,.13},{0.,.14}}, {{0.,1000.},{0.,1000.}}
	};
