...
void WorksheetElementTest::referenceRangeXMouseMove() {
    ...
    QCOMPARE(referenceRange->d_ptr->boundingRectangle.x(), 0);
    QCOMPARE(referenceRange->d_ptr->boundingRectangle.y(), 0);
    QCOMPARE(referenceRange->d_ptr->boundingRectangle.width(), 0);
    QCOMPARE(referenceRange->d_ptr->boundingRectangle.height(), 0);
    ...
    referenceRange->setPositionLogical(QPointF(0.3, 0.5));
    QCOMPARE(referenceRange->positionLogical().x(), 0.3);
    QCOMPARE(referenceRange->positionLogical().y(), 0.5);
    QCOMPARE(referenceRange->position().point.x(), -20);
    QCOMPARE(referenceRange->position().point.y(), 0);
    QCOMPARE(referenceRange->positionLogicalStart().x(), -0.05);
    QCOMPARE(referenceRange->positionLogicalEnd().x(), 0.65);
    QCOMPARE(referenceRange->d_ptr->boundingRectangle.x(), 0);
    QCOMPARE(referenceRange->d_ptr->boundingRectangle.y(), 0);
    QCOMPARE(referenceRange->d_ptr->boundingRectangle.width(), 0);
    QCOMPARE(referenceRange->d_ptr->boundingRectangle.height(), 0);
