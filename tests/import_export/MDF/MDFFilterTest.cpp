...
void MDFFilterTest::testInvalidFile() {
    // Correct extension but invalid content
    QTemporaryFile f("XXXXXX_testfile.mf4");
    QVERIFY(f.open());
    ...
    QCOMPARE(MDF5Filter::isValid(f.fileName()), false);
}

void MDFFilterTest::testValid() {
    const auto filename = QFINDTESTDATA("Testfile1.mf4");
    QCOMPARE(MDF5Filter::isValid(filename), true);
}

void MDFFilterTest::testImportDouble() {
...
void MDFFilterTest::testImportDoublePortion() {
	Spreadsheet spreadsheet("test", false);
	HDF5Filter filter;
...
void MDFFilterTest::testImportInt() {
	Spreadsheet spreadsheet("test", false);
	HDF5Filter filter;
...
void MDFFilterTest::testImportIntPortion() {
	Spreadsheet spreadsheet("test", false);
	HDF5Filter filter;
...
void MDFFilterTest::testImportVLEN() {
	Spreadsheet spreadsheet("test", false);
	HDF5Filter filter;
...
void MDFFilterTest::testImportVLENPortion() {
	Spreadsheet spreadsheet("test", false);
	HDF5Filter filter;
...
void MDFFilterTest::benchDoubleImport_data() {
...
void MDFFilterTest::benchDoubleImport() {
	Spreadsheet spreadsheet("test", false);
	HDF5Filter filter;
